...
1. In NetBox, go to Authentication, create a permission set, for example ***perm_api_ipam_scanner*** and configure this as follows:
	-	Enabled: True
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTc2NzE0OTQ0LC0xODI1NDEzMDkwLDk1NT
